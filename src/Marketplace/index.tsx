                  ...
                  <Card.Body gap="2">
                    ...
                    <Card.Description>
                      <Text className="cardText">
                        ...
                        sizes (text in/text out). The Llama 3.1
                        instruction-tuned text-only models (8B, 70B, 405B) are
                        optimized for multilingual dialogue use cases and
                        outperform many of the available open-source and closed
                  ...
                  <Card.Body gap="2">
                    ...
                    <Card.Description>
                      <Text className="cardText">
                        ...
                        parameters. Mistral-7B-v0.1 outperforms Llama 2 13B on
                        all benchmarks we tested.
                      </Text>
                    </Card.Description>
                  </Card.Body>
                  <Card.Footer
                  ...
                  <Card.Body gap="2">
                    ...
                    <Card.Description>
                      <Text className="cardText">
                        ...
                        pre-trained variants and instruction-tuned variants.
                        Gemma models are well-suited for a variety of text
                        generation tasks, including question answering,
                        summarization, and reasoning. Their relatively small
                        size makes it possible to deploy them in environments
                        with limited resources such as a laptop, desktop or your
                        own cloud infrastructure, democratizing access to state
                        of the art AI models and helping foster innovation for
                        everyone.
                      </Text>
                    </Card.Description>
                  </Card.Body>
